...
public class SubmissionSchema extends org.apache.avro.specific.SpecificRecordBase
    ...
    private static final BinaryMessageEncoder<SubmissionSchema> ENCODER = new BinaryMessageEncoder<>(MODEL$, SCHEMA$);

    private static final BinaryMessageDecoder<SubmissionSchema> DECODER = new BinaryMessageDecoder<>(MODEL$, SCHEMA$);
     ...
     */
    public static SubmissionSchema fromByteBuffer(java.nio.ByteBuffer b) throws java.io.IOException {
    ...
    public SubmissionSchema(
            ...
            java.lang.Long problemId,
            java.lang.Long userId,
            java.lang.Long contestId,
            java.lang.CharSequence status,
            java.util.List<com.codebox.shared_dtos.schema.SubmissionTestcase> submissionTestcases) {
        this.id = id;
        this.code = code;
    ...
    public void put(int field$, java.lang.Object value$) {
        switch (field$) {
            ...
            case 1:
                ...
                break;
            case 2:
                language = (java.lang.CharSequence) value$;
                break;
            case 3:
                problemId = (java.lang.Long) value$;
                break;
            case 4:
                userId = (java.lang.Long) value$;
                break;
            case 5:
                contestId = (java.lang.Long) value$;
                break;
            case 6:
                status = (java.lang.CharSequence) value$;
                break;
            case 7:
                submissionTestcases = (java.util.List<com.codebox.shared_dtos.schema.SubmissionTestcase>) value$;
                break;
            default:
                throw new IndexOutOfBoundsException("Invalid index: " + field$);
        }
     ...
     */
    public static com.codebox.shared_dtos.schema.SubmissionSchema.Builder newBuilder(
            com.codebox.shared_dtos.schema.SubmissionSchema.Builder other) {
        if (other == null) {
            return new com.codebox.shared_dtos.schema.SubmissionSchema.Builder();
        } else {
     ...
     */
    public static com.codebox.shared_dtos.schema.SubmissionSchema.Builder newBuilder(
            com.codebox.shared_dtos.schema.SubmissionSchema other) {
        if (other == null) {
            return new com.codebox.shared_dtos.schema.SubmissionSchema.Builder();
        } else {
            return new com.codebox.shared_dtos.schema.SubmissionSchema.Builder(other);
    ...
    public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<SubmissionSchema>
         ...
         * @return This builder.
         */
        public com.codebox.shared_dtos.schema.SubmissionSchema.Builder setSubmissionTestcases(
                java.util.List<com.codebox.shared_dtos.schema.SubmissionTestcase> value) {
        ...
        public SubmissionSchema build() {
            try {
                ...
                record.language =
                        fieldSetFlags()[2] ? this.language : (java.lang.CharSequence) defaultValue(fields()[2]);
                ...
                record.submissionTestcases = fieldSetFlags()[7]
                        ? this.submissionTestcases
                        : (java.util.List<com.codebox.shared_dtos.schema.SubmissionTestcase>) defaultValue(fields()[7]);
                return record;
    ...
    @SuppressWarnings("unchecked")
    private static final org.apache.avro.io.DatumWriter<SubmissionSchema> WRITER$ =
            (org.apache.avro.io.DatumWriter<SubmissionSchema>) MODEL$.createDatumWriter(SCHEMA$);
    ...
    @SuppressWarnings("unchecked")
    private static final org.apache.avro.io.DatumReader<SubmissionSchema> READER$ =
            (org.apache.avro.io.DatumReader<SubmissionSchema>) MODEL$.createDatumReader(SCHEMA$);
    ...
    public void customDecode(org.apache.avro.io.ResolvingDecoder in) throws java.io.IOException {
        ...
        if (fieldOrder == null) {
            ...
            if (in.readIndex() != 1) {
                ...
                if (a0 == null) {
                    a0 = new SpecificData.Array<com.codebox.shared_dtos.schema.SubmissionTestcase>(
                            (int) size0,
                            SCHEMA$.getField("submissionTestcases")
                                    .schema()
                                    .getTypes()
                                    .get(1));
                    this.submissionTestcases = a0;
                } else a0.clear();
                SpecificData.Array<com.codebox.shared_dtos.schema.SubmissionTestcase> ga0 =
                        (a0 instanceof SpecificData.Array
                                ? (SpecificData.Array<com.codebox.shared_dtos.schema.SubmissionTestcase>) a0
                                : null);
                ...
                switch (fieldOrder[i].pos()) {
                    ...
                    case 7:
                        if (in.readIndex() != 1) {
                            ...
                            long size0 = in.readArrayStart();
                            java.util.List<com.codebox.shared_dtos.schema.SubmissionTestcase> a0 =
                                    this.submissionTestcases;
                            if (a0 == null) {
                                a0 = new SpecificData.Array<com.codebox.shared_dtos.schema.SubmissionTestcase>(
                                        (int) size0,
                            ...
                            for (; 0 < size0; size0 = in.arrayNext()) {
                                for (; size0 != 0; size0--) {
                                    com.codebox.shared_dtos.schema.SubmissionTestcase e0 =
